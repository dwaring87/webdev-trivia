<script setup>
  ...
  const date = useLocalStorage('game-date', new Date().toISOString().split('T')[0]);
                ...
                <div class="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                  ...
                  <div class="mt-2">
                    ...
                    <div class="mt-4">
                      ...
                      <p v-if="date_required && (!date || date === '')" class="text-red-600 text-sm font-semibold">Date is required!</p>
                    </div>
                    ...
                    <div class="mt-4">
                      ...
                      <p v-if="host_required && (!host || host === '')" class="text-red-600 text-sm font-semibold">Host name is required!</p>
                    </div>
                  </div>
