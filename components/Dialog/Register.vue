...
<template>
  <DialogTemplate :open="open" color="green" submitLabel="Register" @close="close" @submit="register">
    ...
    <div class="mt-4">
      ...
      <div class="relative mt-2 rounded-md shadow-sm">
        ...
        <input v-model="name" v-on:keyup.enter="register()"
    ...
    <div class="mt-4">
      ...
      <div class="relative mt-2 rounded-md shadow-sm">
        ...
        <input v-model="email" v-on:keyup.enter="register()"
    ...
    <div class="mt-4">
      ...
      <div class="relative mt-2 rounded-md shadow-sm">
        ...
        <input v-model="password" v-on:keyup.enter="register()"
